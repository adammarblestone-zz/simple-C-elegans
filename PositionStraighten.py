...
if __name__ == '__main__':
    stfile = "OpenWorm/spine-spline.tsv"
    
    for cellName in all_the_cell_names:
        nmlfile = "OpenWorm/generatedNeuroML2/" + cellName + ".nml"
        nml_outfile = "OpenWorm/straightenedNeuroML2/" + cellName + ".nml"
        ...
        writers.NeuroMLWriter.write(doc, nml_outfile)
